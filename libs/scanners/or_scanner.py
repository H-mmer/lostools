    ...
    def perform_request(url, payload):
        ...
        try:
            ...
            for param in query_params:
                ...
                response = requests.get(vulnerable_url, headers=headers, timeout=5, allow_redirects=False, verify=False)
                if response.status_code in [301, 302] and response.headers.get('Location') and payload in response.headers['Location']:
